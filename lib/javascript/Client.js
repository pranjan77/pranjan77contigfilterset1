...
function pranjan77contigfilterset1(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("pranjan77contigfilterset1.filter_contigs",
