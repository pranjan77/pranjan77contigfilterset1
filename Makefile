SERVICE = pranjan77contigfilterset1
SERVICE_CAPS = pranjan77contigfilterset1
SPEC_FILE = pranjan77contigfilterset1.spec
URL = https://kbase.us/services/pranjan77contigfilterset1
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
